...
> three.js·GSAP를 예제 수준에서 실무 수준으로 끌어올리려고, 기법마다 함정과 재사용 구조를 정리한 라이브 쇼케이스 모음입니다.
...
이 간극을 스스로 좁히려고, AI로 씬 초안을 빠르게 만들고 성능·접근성·구조를 직접 다듬어가며 기법마다 함정과 회피법을 정리한 카탈로그를 만들었습니다. 각 쇼케이스는 함정을 하나씩 재현하고, 원인·회피법·직접 수정한 내역을 남깁니다.
