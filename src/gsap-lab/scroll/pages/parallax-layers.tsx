 ...
 */
const LAYERS = [
  { label: "배경", background: "#0f172a", speed: -0.55, bottom: 0 },
  { label: "먼 산", background: "#1e293b", speed: -0.36, bottom: -40 },
  { label: "언덕", background: "#334155", speed: -0.2, bottom: -80 },
  { label: "전경", background: "#64748b", speed: -0.06, bottom: -120 },
];
